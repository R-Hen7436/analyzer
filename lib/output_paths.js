...
function getRunPaths(
    ...
    const behaviorProfileName = normalizeProfileName(behaviorProfileInput);
    if (!behaviorProfileName) {
        throw new Error(
            "behavior profile is required for output paths (workspace/UVP/behavior)"
        );
    }
