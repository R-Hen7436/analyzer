...
if (!WORKSPACE || !PROFILE_INPUT || !BEHAVIOR_PROFILE_INPUT) {
    console.error("Usage:");
    console.error(
        "  node excel_mapper.js <workspace> <uvp_profile> <behavior_profile> [ren_epc|dvu_ai|dvc_ai|all]"
    );
    console.error("");
    console.error("Example:");
    console.error(
        "  node excel_mapper.js ubasrh_KPC02530_2291_matsuri3_mp mo2cc5lpN01_uvp_profile C2YC_uvp_profile"
    );
    console.error(
        "  node excel_mapper.js ubasrh_KPC02530_2291_matsuri3_mp mo2cc5lpN01_uvp_profile C2YC_uvp_profile dvu_ai"
    );
    process.exit(1);
}
...
const RUN_PATHS = ensureRunDirs(
    getRunPaths(WORKSPACE, PROFILE_INPUT, BEHAVIOR_PROFILE_INPUT)
);
...
const MAP_MODULES = {
    ...
    dvu_ai: {
        ...
        documentPath:
            ...
            path.join(PROJECT_ROOT, "document", "dvuAI_change_point_list.xlsx"),
        outputPath:
            (RUN_PATHS.mapUpdatedXlsxByModule &&
    ...
    dvc_ai: {
        ...
        documentPath:
            ...
            path.join(PROJECT_ROOT, "document", "dvcAI_change_point_list.xlsx"),
        outputPath:
            (RUN_PATHS.mapUpdatedXlsxByModule &&
...
async function main() {
    ...
    console.log(`UVP profile: ${RUN_PATHS.profileName}`);
    console.log(`Behavior profile: ${RUN_PATHS.behaviorProfileName}`);
