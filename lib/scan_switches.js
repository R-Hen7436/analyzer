...
if (!WORKSPACE || !PROFILE_INPUT || !BEHAVIOR_PROFILE_INPUT) {
    console.error("Usage:");
    console.error(
        "  node scan_switches.js <workspace> <uvp_profile> <behavior_profile> [ren_epc|dvu_ai|dvc_ai|all]"
    );
    console.error("");
    console.error("Example:");
    console.error(
        "  node scan_switches.js ubasrh_KPC02530_2291_matsuri3_mp mo2cc5lpN01_uvp_profile C2YC_uvp_profile"
    );
    console.error(
        "  node scan_switches.js ubasrh_KPC02530_2291_matsuri3_mp mo2cc5lpN01_uvp_profile C2YC_uvp_profile dvu_ai"
    );
    console.error("");
    console.error("Note:");
    console.error(
        "  UVP and behavior profiles are used for output folder organization only."
    );
